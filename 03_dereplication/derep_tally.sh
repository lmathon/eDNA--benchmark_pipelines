...
tally='singularity exec 99_utils/images/ednatools.img tally'
...
main_dir='03_dereplication/Outputs/02_tally/main'
fin_dir='03_dereplication/Outputs/02_tally/final'
