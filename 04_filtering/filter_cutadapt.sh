...
main_dir=`pwd`"/04_filtering/Outputs/02_cutadapt/main"
fin_dir=`pwd`"/04_filtering/Outputs/02_cutadapt/final"
...
echo "/usr/bin/time $cutadapt "$dereplicated_sample" -m 20 --max-n 0 -j 1 -o "$good_sequence_sample >> $sample_sh
