...
$vsearch --usearch_global $all_sample_sequences_sort --db $refdb_dir --notrunclabels --id 0.98 --fasta_width 0 --top_hits_only --blast6out $all_sample_sequences_vsearch_tag
