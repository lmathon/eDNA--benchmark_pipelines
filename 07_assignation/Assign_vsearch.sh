...
/usr/bin/time $vsearch --usearch_global $all_sample_sequences_uniq --db $refdb_dir --blast6out --notrunclabels --id 0.9 --fasta_width 0 --top_hits_only --sizeout --matched $all_sample_sequences_tag
