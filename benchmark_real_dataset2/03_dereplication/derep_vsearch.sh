...
main_dir=`pwd`"/benchmark_real_dataset2/03_dereplication/Outputs/01_vsearch/main"
fin_dir=`pwd`"/benchmark_real_dataset2/03_dereplication/Outputs/01_vsearch/final"
...
echo "$container_python2 benchmark_real_dataset2/03_dereplication/vsearch_to_obifasta.py -f "$dereplicated_sample" -o "$formated_sample >> $sample_sh
