...
main_dir=`pwd`"/benchmark_real_dataset2/obitools_reference/outputs_obitools/main"
fin_dir=`pwd`"/benchmark_real_dataset2/obitools_reference/outputs_obitools/final"
