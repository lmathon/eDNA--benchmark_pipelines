...
refdb_dir=`pwd`"/benchmark_real_dataset2/06_assignation/db_carry_vsearch.fasta"
## path to outputs final and temporary (main)
main_dir=`pwd`"/benchmark_real_dataset2/06_assignation/Outputs/01_vsearch/main"
fin_dir=`pwd`"/benchmark_real_dataset2/06_assignation/Outputs/01_vsearch/final"
...
## Create final table
python3 benchmark_real_dataset2/06_assignation/vsearch2obitab.py -a $all_sample_sequences_vsearch_tag -o $fin_dir/"$pref".csv
