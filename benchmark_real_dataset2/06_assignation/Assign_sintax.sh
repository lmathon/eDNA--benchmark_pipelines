...
refdb_dir=`pwd`"/benchmark_real_dataset2/06_assignation/db_carry_sintax.fasta"
## path to outputs final and temporary (main)
main_dir=`pwd`"/benchmark_real_dataset2/06_assignation/Outputs/02_sintax/main"
fin_dir=`pwd`"/benchmark_real_dataset2/06_assignation/Outputs/02_sintax/final"
...
python3 benchmark_real_dataset2/06_assignation/unique_id_obifasta.py $all_sample_sequences_sort > $all_sample_sequences_uniqid
...
## Create final table
python3 benchmark_real_dataset2/06_assignation/sintax2obitab.py -s $all_sample_sequences_sintax_ann -o $fin_dir/"$step".csv
