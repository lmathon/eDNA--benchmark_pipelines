...
main_dir=`pwd`"/benchmark_real_dataset2/01_merging/Outputs/01_vsearch/main"
fin_dir=`pwd`"/benchmark_real_dataset2/01_merging/Outputs/01_vsearch/final"
...
/usr/bin/time $vsearch --fastq_mergepairs ${R1_fastq} --reverse ${R2_fastq} --fastq_maxdiffpct 25 --threads 16 --fastq_allowmergestagger  --fastqout ${assembly}
