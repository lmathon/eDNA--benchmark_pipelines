...
main_dir=`pwd`"/benchmark_real_dataset2/02_demultiplex/Outputs/01_cutadapt/main"
fin_dir=`pwd`"/benchmark_real_dataset2/02_demultiplex/Outputs/01_cutadapt/final"
