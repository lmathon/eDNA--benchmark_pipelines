...
main_dir=`pwd`"/benchmark_real_dataset/03_dereplication/Outputs/01_vsearch/main"
fin_dir=`pwd`"/benchmark_real_dataset/03_dereplication/Outputs/01_vsearch/final"
