...
refdb_dir=${INPUT_DATA}"reference_database/db_carry_sintax_all.fasta"
...
python3 benchmark_real_dataset/06_assignation/unique_id_obifasta.py $all_sample_sequences_sort > $all_sample_sequences_uniqid
