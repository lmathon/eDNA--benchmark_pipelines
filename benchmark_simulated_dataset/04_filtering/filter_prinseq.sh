...
main_dir=`pwd`"/benchmark_simulated_dataset/04_filtering/Outputs/04_prinseq/main"
fin_dir=`pwd`"/benchmark_simulated_dataset/04_filtering/Outputs/04_prinseq/final"
