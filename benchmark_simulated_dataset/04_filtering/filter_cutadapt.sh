...
main_dir=`pwd`"/benchmark_simulated_dataset/04_filtering/Outputs/02_cutadapt/main"
fin_dir=`pwd`"/benchmark_simulated_dataset/04_filtering/Outputs/02_cutadapt/final"
