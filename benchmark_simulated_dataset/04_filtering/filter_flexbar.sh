...
main_dir=`pwd`"/benchmark_simulated_dataset/04_filtering/Outputs/03_flexbar/main"
fin_dir=`pwd`"/benchmark_simulated_dataset/04_filtering/Outputs/03_flexbar/final"
