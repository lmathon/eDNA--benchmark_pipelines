...
main_dir=`pwd`"/benchmark_simulated_dataset/04_filtering/Outputs/01_vsearch/main"
fin_dir=`pwd`"/benchmark_simulated_dataset/04_filtering/Outputs/01_vsearch/final"
