...
main_dir=`pwd`"/benchmark_simulated_dataset/04_filtering/Outputs/05_fastp/main"
fin_dir=`pwd`"/benchmark_simulated_dataset/04_filtering/Outputs/05_fastp/final"
