...
main_dir=`pwd`"/benchmark_simulated_dataset/obitools_reference/outputs_obitools/main"
fin_dir=`pwd`"/benchmark_simulated_dataset/obitools_reference/outputs_obitools/final"
