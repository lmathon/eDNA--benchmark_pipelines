...
main_dir=`pwd`"/benchmark_simulated_dataset/01_merging/Outputs/01_vsearch/main"
fin_dir=`pwd`"/benchmark_simulated_dataset/01_merging/Outputs/01_vsearch/final"
