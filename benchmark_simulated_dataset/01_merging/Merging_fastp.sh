...
main_dir=`pwd`"/benchmark_simulated_dataset/01_merging/Outputs/07_fastp/main"
fin_dir=`pwd`"/benchmark_simulated_dataset/01_merging/Outputs/07_fastp/final"
...
/usr/bin/time $fastp -i ${R1_fastq} -I ${R2_fastq} --merge --overlap_len_require 10 --overlap_diff_limit 15 --overlap_diff_percent_limit 25 --disable_length_filtering -w 1 --merged_out ${assembly}
