...
main_dir=`pwd`"/benchmark_simulated_dataset/01_merging/Outputs/03_fastqjoin/main"
fin_dir=`pwd`"/benchmark_simulated_dataset/01_merging/Outputs/03_fastqjoin/final"
