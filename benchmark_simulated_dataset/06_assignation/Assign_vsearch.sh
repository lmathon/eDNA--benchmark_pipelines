...
refdb_dir=${INPUT_DATA}"/reference_database/db_teleo_vsearch.fasta"
## path to outputs final and temporary (main)
main_dir=`pwd`"/benchmark_simulated_dataset/06_assignation/Outputs/01_vsearch/main"
fin_dir=`pwd`"/benchmark_simulated_dataset/06_assignation/Outputs/01_vsearch/final"
...
python3 benchmark_simulated_dataset/06_assignation/unique_id_obifasta.py $all_sample_sequences_sort > $all_sample_sequences_uniqid
...
## Create final table
python3 benchmark_simulated_dataset/06_assignation/vsearch2obitab.py -a $all_sample_sequences_vsearch_tag -o $fin_dir/"$pref".csv
