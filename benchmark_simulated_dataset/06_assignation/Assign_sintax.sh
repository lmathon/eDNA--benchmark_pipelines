...
refdb_dir=${INPUT_DATA}"/reference_database/db_teleo_sintax.fasta"
## path to outputs final and temporary (main)
main_dir=`pwd`"/benchmark_simulated_dataset/06_assignation/Outputs/02_sintax/main"
fin_dir=`pwd`"/benchmark_simulated_dataset/06_assignation/Outputs/02_sintax/final"
...
## Create final table
python3 benchmark_simulated_dataset/06_assignation/sintax2obitab.py -s $all_sample_sequences_sintax_ann -o $fin_dir/"$step".csv
