...
source benchmark_simulated_dataset/98_infos/config.sh
...
## path to 'tags.fasta'
Tags=`pwd`"/benchmark_simulated_dataset/optimized_pipeline/Tags.fasta"
...
main_dir=`pwd`"/benchmark_simulated_dataset/optimized_pipeline/Outputs/main"
fin_dir=`pwd`"/benchmark_simulated_dataset/optimized_pipeline/Outputs/final"
...
echo "$container_python2 benchmark_simulated_dataset/optimized_pipeline/vsearch_to_obifasta.py -f "$dereplicated_sample" -o "$formated_sample >> $sample_sh
...
echo "$obiannotate -S 'size:count' "$good_sequence_sample" | $container_python2 benchmark_simulated_dataset/optimized_pipeline/formate_header.py > "$formated_sequence_sample >> $sample_sh
...
python3 benchmark_simulated_dataset/optimized_pipeline/unique_id_obifasta.py $all_sample_sequences_sort > $all_sample_sequences_uniqid
...
python3 benchmark_simulated_dataset/optimized_pipeline/vsearch2obitab.py -a $all_sample_sequences_vsearch_preformat -o $fin_dir/opt_pipeline.csv
