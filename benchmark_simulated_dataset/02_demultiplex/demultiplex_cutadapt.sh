...
main_dir=`pwd`"/benchmark_simulated_dataset/02_demultiplex/Outputs/01_cutadapt/main"
fin_dir=`pwd`"/benchmark_simulated_dataset/02_demultiplex/Outputs/01_cutadapt/final"
