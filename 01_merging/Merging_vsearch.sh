...
main_dir='/home/lmathon/Comparaison_pipelines/01_In_silico/01_Merging/Outputs/02_vsearch/main'
fin_dir='/home/lmathon/Comparaison_pipelines/01_In_silico/01_Merging/Outputs/02_vsearch/final'


###################################################################################################################

# Assemblage des reads forward et reverse
/usr/bin/time $vsearch --fastq_mergepairs $R1_fastq --reverse $R2_fastq --fastq_allowmergestagger  --fastqout $main_dir/$pref.fastq
