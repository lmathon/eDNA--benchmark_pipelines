...
main_dir=`pwd`"/01_merging/Outputs/05_pear/main"
fin_dir=`pwd`"/01_merging/Outputs/05_pear/final"
...
/usr/bin/time $pear -f ${R1_fastq} -r ${R2_fastq} -v 10 -c 0 -n 0 -o > ${assembly}
