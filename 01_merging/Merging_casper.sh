...
casper='singularity exec /home/lmathon/ednatools.img casper'
...
main_dir='/home/lmathon/Comparaison_pipelines/01_In_silico/01_Merging/Outputs/05_casper/main'
fin_dir='/home/lmathon/Comparaison_pipelines/01_In_silico/01_Merging/Outputs/05_casper/final'

######################################################################################################

# Assemblage des reads forward et reverse
#/usr/bin/time $casper $R1_fastq $R2_fastq -o $main_dir/"$pref" 
